...
mkdir dataset
curl -o dataset/esnli_train_1.csv https://raw.githubusercontent.com/OanaMariaCamburu/e-SNLI/master/dataset/esnli_train_1.csv
curl -o dataset/esnli_train_2.csv https://raw.githubusercontent.com/OanaMariaCamburu/e-SNLI/master/dataset/esnli_train_2.csv
curl -o dataset/esnli_dev.csv https://raw.githubusercontent.com/OanaMariaCamburu/e-SNLI/master/dataset/esnli_dev.csv
curl -o dataset/esnli_test.csv https://raw.githubusercontent.com/OanaMariaCamburu/e-SNLI/master/dataset/esnli_test.csv
mkdir dataset/GloVe
...
#intersent2.pkl (not used)
gdown 1NaB79RJEW79VLHo0WBCR1SxLwbsTUUd5

#download trained InferSent NLI model
gdown 19HBWkX-FY6inoAjseRJ4zhp2GrLM4DjB

#download trained SentenceTransformer encoder
gdown 1geWoPK33bpS8K9kPyMQxdbvU8i6lNmjH
#download train SentenceTransformer NLI model
gdown 1wnKo6wgmQlW5rV5pvIajQsEoDOAQIHf7
